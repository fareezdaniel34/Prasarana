                ...
                <div class="dropdown">
                    <div class="btn-group">
                        <button id="SectionName"
                            style="display:none; font-weight: bold; font-size: x-small; background-color: #54bab9;">
                            << /button>

                                <button onclick="myFunction()" id="train_id" class="dropbtn"
                                    style="font-weight: bold; max-height: 10px; max-width:50px; font-size: x-small;"><?php echo $train_id?></button>
                                <button id="SectionNames"
                                    style="display:none; font-weight: bold; font-size: x-small; background-color: #54bab9;">></button>
                    </div>
                            ...
                            <section class="input-container">
                                ...
                                <div class="modal-body">
                                    <div style="margin:auto; display:grid;">
                                        ...
                                        Add Train Name:<input type="text" name="train_id" placeholder="Enter train name"
                                            required>
    ...
    <div class="bg">
        ...
        <!-- <div class="box">
            ...
            <div class="dragscroll"
                style="width:1920px; height: 1080px; overflow: scroll; cursor: grab; cursor : -o-grab; cursor : -moz-grab; cursor : -webkit-grab;">
